...
// IWYU pragma: private, include "maneuver/srv/arm_disarm.h"


#ifndef MANEUVER__SRV__DETAIL__ARM_DISARM__FUNCTIONS_H_
#define MANEUVER__SRV__DETAIL__ARM_DISARM__FUNCTIONS_H_
...
/// Initialize srv/ArmDisarm message.
/**
 ...
 * )) before or use
 * maneuver__srv__ArmDisarm_Request__create()
...
/// Finalize srv/ArmDisarm message.
/**
...
/// Create srv/ArmDisarm message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * maneuver__srv__ArmDisarm_Request__init().
...
/// Destroy srv/ArmDisarm message.
/**
 * It calls
 * maneuver__srv__ArmDisarm_Request__fini()
...
/// Check for srv/ArmDisarm message equality.
/**
...
/// Initialize array of srv/ArmDisarm messages.
/**
...
/// Finalize array of srv/ArmDisarm messages.
/**
 * It calls
 * maneuver__srv__ArmDisarm_Request__fini()
...
/// Create array of srv/ArmDisarm messages.
/**
 * It allocates the memory for the array and calls
 * maneuver__srv__ArmDisarm_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArmDisarm messages.
/**
 * It calls
 * maneuver__srv__ArmDisarm_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmDisarm message array equality.
/**
...
/// Copy an array of srv/ArmDisarm messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * maneuver__srv__ArmDisarm_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * maneuver__srv__ArmDisarm_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It calls
 * maneuver__srv__ArmDisarm_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It allocates the memory for the array and calls
 * maneuver__srv__ArmDisarm_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It calls
 * maneuver__srv__ArmDisarm_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * maneuver__srv__ArmDisarm_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * maneuver__srv__ArmDisarm_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It calls
 * maneuver__srv__ArmDisarm_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It allocates the memory for the array and calls
 * maneuver__srv__ArmDisarm_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_maneuver
...
/**
 * It calls
 * maneuver__srv__ArmDisarm_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MANEUVER__SRV__DETAIL__ARM_DISARM__FUNCTIONS_H_
