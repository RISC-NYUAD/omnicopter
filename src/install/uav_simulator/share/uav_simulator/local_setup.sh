...
: ${AMENT_CURRENT_PREFIX:="/ros_ws/src/install/uav_simulator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uav_simulator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uav_simulator/environment/path.sh"
