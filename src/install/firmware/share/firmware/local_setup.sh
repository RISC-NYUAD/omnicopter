...
: ${AMENT_CURRENT_PREFIX:="/ros_ws/src/install/firmware"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/firmware/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/firmware/environment/path.sh"
