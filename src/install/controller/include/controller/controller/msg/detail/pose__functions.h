...
#ifndef CONTROLLER__MSG__DETAIL__POSE__FUNCTIONS_H_
#define CONTROLLER__MSG__DETAIL__POSE__FUNCTIONS_H_
 ...
 * controller__msg__Pose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * controller__msg__Pose__Sequence__fini()
 * on the array,
...
#endif  // CONTROLLER__MSG__DETAIL__POSE__FUNCTIONS_H_
