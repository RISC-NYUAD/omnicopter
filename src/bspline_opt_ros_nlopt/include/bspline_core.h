...
struct Sampled {
  ...
  std::vector<std::array<double,3>> rpy; // <-- NEW: store delta RPY at each row
};
...
struct Params {
  ...
  std::vector<double> lb7{-6.0,-6.0,-6.0, -2*M_PI, -2*M_PI, -2*M_PI}, ub7{6.0,6.0,6.0, 2*M_PI, 2*M_PI, 2*M_PI};
