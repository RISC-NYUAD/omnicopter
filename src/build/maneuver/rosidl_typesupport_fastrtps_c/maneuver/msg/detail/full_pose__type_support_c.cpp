...
#include "maneuver/msg/detail/full_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/accel__functions.h"  // acc
#include "geometry_msgs/msg/detail/pose__functions.h"  // pose
#include "geometry_msgs/msg/detail/twist__functions.h"  // vel
...
using _FullPose__ros_msg_type = maneuver__msg__FullPose;
  ...
  maneuver__msg__FullPose * ros_message)
{
  ...
  // Field name: vel
  {
    cdr_deserialize_geometry_msgs__msg__Twist(cdr, &ros_message->vel);
  }

  // Field name: acc
  {
    cdr_deserialize_geometry_msgs__msg__Accel(cdr, &ros_message->acc);
  }
...
size_t get_serialized_size_maneuver__msg__FullPose(
  ...
  size_t current_alignment)
{
  const _FullPose__ros_msg_type * ros_message = static_cast<const _FullPose__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = maneuver__msg__FullPose;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const maneuver__msg__FullPose * ros_message = static_cast<const maneuver__msg__FullPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_maneuver__msg__FullPose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  maneuver__msg__FullPose * ros_message = static_cast<maneuver__msg__FullPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_maneuver__msg__FullPose(cdr, ros_message);
}

static uint32_t _FullPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_maneuver__msg__FullPose(
...
static size_t _FullPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_maneuver__msg__FullPose(
...
static message_type_support_callbacks_t __callbacks_FullPose = {
  "maneuver::msg",
  "FullPose",
...
static rosidl_message_type_support_t _FullPose__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FullPose,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, maneuver, msg, FullPose)() {
  return &_FullPose__type_support;
}
