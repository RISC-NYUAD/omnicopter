...
#include "maneuver/srv/detail/land__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const maneuver::srv::Land_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  maneuver::srv::Land_Request & ros_message)
{
  // Member: height_1
  cdr >> ros_message.height_1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = maneuver::srv::Land_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const maneuver::srv::Land_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<maneuver::srv::Land_Request *>(
    untyped_ros_message);
...
{
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maneuver, srv, Land_Request)() {
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_maneuver
cdr_serialize(
  const maneuver::srv::Land_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  maneuver::srv::Land_Response & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = maneuver::srv::Land_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const maneuver::srv::Land_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<maneuver::srv::Land_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maneuver, srv, Land_Response)() {
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Response__handle;
}
...
// functions for maneuver::srv::Land_Request already declared above

// functions for maneuver::srv::Land_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_maneuver
cdr_serialize(
  const maneuver::srv::Land_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  maneuver::srv::Land_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        maneuver::srv::typesupport_fastrtps_cpp::max_serialized_size_Land_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        maneuver::srv::typesupport_fastrtps_cpp::max_serialized_size_Land_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = maneuver::srv::Land_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        maneuver::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Land_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        maneuver::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Land_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const maneuver::srv::Land_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<maneuver::srv::Land_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maneuver, srv, Land_Event)() {
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land_Event__handle;
}
...
static const rosidl_service_type_support_t _Land__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<maneuver::srv::Land_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<maneuver::srv::Land_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<maneuver::srv::Land_Event>(),
...
{
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maneuver, srv, Land)() {
  return &maneuver::srv::typesupport_fastrtps_cpp::_Land__handle;
}
