...
#include "maneuver/msg/detail/full_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = maneuver::msg::FullPose;
    is_plain =
      (
...
static bool _FullPose__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const maneuver::msg::FullPose *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _FullPose__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<maneuver::msg::FullPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FullPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const maneuver::msg::FullPose *>(
...
static size_t _FullPose__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_FullPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FullPose__callbacks = {
  "maneuver::msg",
  "FullPose",
  _FullPose__cdr_serialize,
  _FullPose__cdr_deserialize,
  _FullPose__get_serialized_size,
  _FullPose__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _FullPose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FullPose__callbacks,
...
{
  return &maneuver::msg::typesupport_fastrtps_cpp::_FullPose__handle;
}
