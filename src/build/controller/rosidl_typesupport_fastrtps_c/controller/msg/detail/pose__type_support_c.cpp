...
#include "controller/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = controller__msg__Pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller__msg__Pose;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const controller__msg__Pose * ros_message = static_cast<const controller__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_controller__msg__Pose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  controller__msg__Pose * ros_message = static_cast<controller__msg__Pose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_controller__msg__Pose(cdr, ros_message);
}

static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__msg__Pose(
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__msg__Pose(
