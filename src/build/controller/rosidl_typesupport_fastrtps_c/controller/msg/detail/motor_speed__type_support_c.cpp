...
#include "controller/msg/detail/motor_speed__rosidl_typesupport_fastrtps_c.h"
...
using _MotorSpeed__ros_msg_type = controller__msg__MotorSpeed;
...
{
  const _MotorSpeed__ros_msg_type * ros_message = static_cast<const _MotorSpeed__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = controller__msg__MotorSpeed;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const controller__msg__MotorSpeed * ros_message = static_cast<const controller__msg__MotorSpeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_controller__msg__MotorSpeed(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  controller__msg__MotorSpeed * ros_message = static_cast<controller__msg__MotorSpeed *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_controller__msg__MotorSpeed(cdr, ros_message);
}

static uint32_t _MotorSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller__msg__MotorSpeed(
...
static size_t _MotorSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller__msg__MotorSpeed(
...
static message_type_support_callbacks_t __callbacks_MotorSpeed = {
  "controller::msg",
  "MotorSpeed",
...
static rosidl_message_type_support_t _MotorSpeed__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorSpeed,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller, msg, MotorSpeed)() {
  return &_MotorSpeed__type_support;
}
