...
public:
    ...
    static MatrixXd optimalTrajFromWay(VectorXd x, VectorXd y, double v_max, double a_max, Vector2d v_start, Vector2d a_start, int n, VectorXd weights, int last_point,
