...
if(NOT "/opt/ros/noetic/flightSoftware/devel/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'maneuver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/noetic/flightSoftware/src/omni_maneuver-main/${idir}'.  ${_report}")
    endif()
